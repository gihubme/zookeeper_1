package eu.nnn4.cloudcomputing.demos;/*
 *  to test, create /target_znode and then create children, update data, delete node
 *  to see output for different event types
 */
